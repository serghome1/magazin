<?php get_header(); ?>
    <div id="content">
      ...
      <div class="post"  id="post-<?php the_ID(); ?>">
		...
		<div class="links">Автор: <?php the_author() ?>&nbsp;&nbsp;&nbsp;<?php the_time('d M Y') ?>&nbsp;&nbsp;&nbsp;Рубрика: <?php the_category(', ') ?>&nbsp;&nbsp;&nbsp;<?php edit_post_link('Править','','&nbsp;&nbsp;&nbsp;'); ?><?php comments_popup_link('Ваш отзыв &raquo;', '1 отзыв &raquo;', 'Отзывов: % &raquo;'); ?></div>
      </div>
      <?php endwhile; ?>
	  <?php else : ?>
