...
if ( ! function_exists( 'wen_business_get_default_theme_options' ) ) :
  ...
  function wen_business_get_default_theme_options(){
    $defaults = array();
    $defaults = apply_filters( 'wen_business_filter_default_theme_options', $defaults );
    return $defaults;
  }
...
if ( ! function_exists( 'wen_business_get_option' ) ) :
  ...
  function wen_business_get_option( $key='' ){
    ...
    $default = ( isset( $wen_business_default_theme_options[ $key ] ) ) ? $wen_business_default_theme_options[ $key ] : '';
    $theme_options = get_theme_mod( 'theme_options', $wen_business_default_theme_options );
    $theme_options = array_merge( $wen_business_default_theme_options, $theme_options );
    $value = '';
